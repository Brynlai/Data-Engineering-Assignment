...
class WikipediaStreamingProcessor:
    ...
    def process_streaming_data(self, input_dir: str, output_dir: str, timeout: int = 10):
        ...
        # Use a separate thread to stop the query after the timeout
        ...
        # Block and wait for the streaming query to finish
...
def mainStreaming():
    ...
    processor.process_streaming_data(input_dir, output_dir, timeout=10)
